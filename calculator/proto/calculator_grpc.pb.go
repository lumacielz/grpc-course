...
const (
	...
	CalculatorService_PrimeDecomposition_FullMethodName = "/calculator.CalculatorService/PrimeDecomposition"
)
...
func (c *calculatorServiceClient) PrimeDecomposition(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeDecompositionClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], CalculatorService_PrimeDecomposition_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
